...
import com.example.matheasyapp.view.tool.keyboard.KeyboardUnitPrice.CallBackFunction
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class BottomsheftKeyboardCostMaterial : BottomSheetDialogFragment() {
    ...
    companion object {
        fun newInstance(text: String): BottomsheftKeyboardCostMaterial {
            val fragment = BottomsheftKeyboardCostMaterial()
            val args = Bundle()
