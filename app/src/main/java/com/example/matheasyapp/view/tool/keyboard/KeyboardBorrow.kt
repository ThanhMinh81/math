...
import com.example.matheasyapp.view.tool.keyboard.BottomsheftKeyboardCostMaterial.CallBackFunction
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class KeyboardBorrow : BottomSheetDialogFragment() {
    ...
    lateinit var listener: KeyboardBorrow.CallBackFunction
    ...
    companion object {
        fun newInstance(text: String): KeyboardBorrow {
            val fragment = KeyboardBorrow()
            val args = Bundle()
