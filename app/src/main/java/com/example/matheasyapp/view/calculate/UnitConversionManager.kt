...
class UnitConversionManager {
    ...
    val listVolume = ArrayList<String>()
    ...
    private lateinit var titleConverter: String

    private lateinit var resultConverter: String
    ...
    public fun unitConverter(newValue: String): String {
